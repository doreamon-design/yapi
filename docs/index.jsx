...
features: 
  - { name: '权限管理', desc: 'API-DOCS 成熟的团队管理扁平化项目权限配置满足各类企业的需求' }
...
footer:
  copyRight:
    name: 'APIDOCS Team'
    href: 'https://apidocs.org/'
  links:
    团队网址:
      - { name: 'APIDOCS', href: 'https://apidocs.org/' }
    Git仓库:
    - { name: 'Github', href: 'https://github.com/APIDOCS/apidocs' }
