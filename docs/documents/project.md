...
API-DOCS 支持项目复制功能，但是无法复制项目中的测试集合 list。
...
> 删除项目是高风险操作，因此 API-DOCS 对这个操作进行了特别的约束。
...
处理请求参数，或返回数据，可能还会涉及到异步处理，比如 ajax 请求，API-DOCS 在 v1.3.13 版本支持了异步处理。
...
[openapi 文档地址](/doc/index.html/openapi.html)
